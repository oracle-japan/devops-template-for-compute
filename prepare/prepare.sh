...
oci iam dynamic-group create --name OCI_DevOps_Policy_Compute --description OCI_DevOps_Policy_Compute --matching-rule "{instance.compartment.id = '${compartment_id}'}"

#Create Policy
oci iam policy create --name OCI_DevOps_Policy_Compute --description OCI_DevOps_Policy_Compute --compartment-id "${compartment_id}" --statements '["Allow dynamic-group OCI_DevOps_Dynamic_Group_Compute to use instance-agent-command-execution-family in compartment id '${compartment_id}'", "Allow dynamic-group OCI_DevOps_Dynamic_Group_Compute to to manage instance-agent-command-family in compartment '${compartment_id}'"]'
